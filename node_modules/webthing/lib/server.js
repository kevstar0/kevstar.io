...
exports.WebThingServer = exports.MultipleThings = exports.SingleThing = void 0;
...
exports.SingleThing = SingleThing;
/**
...
exports.MultipleThings = MultipleThings;
/**
...
class ThingsHandler extends BaseHandler {
    ...
    get(req, res) {
        ...
        res.json(this.things.getThings().map((thing) => {
...
class WebThingServer {
     ...
     */
    constructor(things, port = null, hostname = null, sslOptions = null, additionalRoutes = null, basePath = '/', disableHostValidation = false) {
        this.things = things;
        ...
        if (this.things instanceof MultipleThings) {
            ...
            this.router.get('/:thingId/properties/:propertyName', (req, res) => propertyHandler.get(req, res));
            this.router.put('/:thingId/properties/:propertyName', (req, res) => propertyHandler.put(req, res));
            ...
            this.router.get('/:thingId/actions/:actionName/:actionId', (req, res) => actionIdHandler.get(req, res));
            this.router.put('/:thingId/actions/:actionName/:actionId', (req, res) => actionIdHandler.put(req, res));
            this.router.delete('/:thingId/actions/:actionName/:actionId', (req, res) => actionIdHandler.delete(req, res));
            ...
            this.router.get('/actions/:actionName/:actionId', (req, res) => actionIdHandler.get(req, res));
            this.router.put('/actions/:actionName/:actionId', (req, res) => actionIdHandler.put(req, res));
            this.router.delete('/actions/:actionName/:actionId', (req, res) => actionIdHandler.delete(req, res));
...
exports.WebThingServer = WebThingServer;
