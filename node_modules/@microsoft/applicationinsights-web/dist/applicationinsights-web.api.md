...
export class Sender extends BaseTelemetryPlugin implements IChannelControlsAI {
    ...
    // (undocumented)
    resume(): void;
    // Warning: (ae-forgotten-export) The symbol "Sample" needs to be exported by the entry point applicationinsights-web.d.ts
    //
    // (undocumented)
...
//
// types/Initialization.d.ts:58:5 - (ae-forgotten-export) The symbol "Data" needs to be exported by the entry point applicationinsights-web.d.ts
// types/Initialization.d.ts:59:5 - (ae-forgotten-export) The symbol "Base" needs to be exported by the entry point applicationinsights-web.d.ts
// types/Initialization.d.ts:60:5 - (ae-forgotten-export) The symbol "Envelope" needs to be exported by the entry point applicationinsights-web.d.ts
// types/Initialization.d.ts:69:5 - (ae-forgotten-export) The symbol "Data" needs to be exported by the entry point applicationinsights-web.d.ts
// types/Initialization.d.ts:71:5 - (ae-forgotten-export) The symbol "ConfigurationManager" needs to be exported by the entry point applicationinsights-web.d.ts
// types/Initialization.d.ts:72:5 - (ae-forgotten-export) The symbol "ContextTagKeys" needs to be exported by the entry point applicationinsights-web.d.ts
// types/Initialization.d.ts:73:5 - (ae-forgotten-export) The symbol "IDataSanitizer" needs to be exported by the entry point applicationinsights-web.d.ts
// types/Initialization.d.ts:74:5 - (ae-forgotten-export) The symbol "TelemetryItemCreator" needs to be exported by the entry point applicationinsights-web.d.ts
