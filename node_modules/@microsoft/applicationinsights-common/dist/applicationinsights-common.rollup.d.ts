/*
 * Microsoft Application Insights Common JavaScript Library, 2.6.4
...
export declare interface IChannelControlsAI extends IChannelControls {
}
...
export declare function isBeaconApiSupported(): boolean;
